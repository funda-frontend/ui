<template>
    <div class="relative">
        <select
            class="appearance-none cursor-pointer w-full rounded-sm border border-solid bg-white shadow-sm py-2 px-4 outline-none text-base font-normal h-11 disabled:bg-light-3"
            :disabled="disabled"
            :class="{
